...
from data.unaligned_dataset import UnalignedDataset  # import your custom dataset class
...
model.load_state_dict(
    torch.load("./checkpoints/cyclegan_unet_ORL_230406/latest_net_G_A.pth")
)
